...
In a [recent blog post](https://aazuspan.vercel.app/blog/minifying-modules), I found that shrinking an Earth Engine module's size by 75% had almost no effect on import speed in the Code Editor because most of the time was spent waiting for Earth Engine to find it, not downloading its contents. If that's the case, then is a module that's split up across multiple files much slower to import than a module contained in a single file?
...
<center><img src="/images/nested_deep.svg" alt="A diagram showing 6 modules connected in a row"></img></center>
...
<center><img src="/images/nested_wide.svg" alt="A diagram showing one module branching out to 5 submodules"></img></center>
...
<center><img src="/images/nested_allinone.svg" alt="A diagram showing one big module."></img></center>
...
![Browser developer tools showing 6 requests occuring one after the other](/images/nested_test_deep.png)
...
![Browser developer tools showing 6 requests, with 5 occurring simultaneously after the first finishes](/images/nested_test_wide.png)
...
![Browser developer tools showing a single request](/images/nested_test_allinone.png)
...
<iframe src="/images/nested_module_scale.html" width=800 height=400 frameBorder="0"></iframe>
...
<center><img src="/images/snazzy_structure.svg" alt="A diagram showing three modules connected in a row"></img></center>
