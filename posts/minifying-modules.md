...
summary: Websites minify code to make pages load faster, so can we speed up Earth Engine imports by minifying our modules? Nope, not really. It turns out there's more to import times than file size.
date: "2022-06-01"
---
...
![The browser can't tell the difference between minified and regular code.](/images/minified_same_picture.jpeg)
...
![Browser developer tools showing the GET request](/images/demo_traffic.png)
...
![File size decreased from 38.3 kB to 9.08 kB (76.27%)](/images/code_size.png)
...
<iframe src="/images/minified_total_time.html" width="900" height="360" frameBorder="0"></iframe>
...
<iframe src="/images/minified_download_server_time.html" width="800" height="360" frameBorder="0"></iframe>
